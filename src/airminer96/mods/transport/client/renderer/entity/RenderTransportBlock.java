...
public class RenderTransportBlock extends Render {
	...
	public void doRenderAircraftBlock(EntityTransportBlock par1EntityTransportBlock, double par2, double par4, double par6, float par8, float par9) {
		...
		TileEntity tileEntity = par1EntityTransportBlock.getTransportWorld().getWorld().getBlockTileEntity(par1EntityTransportBlock.blockX, par1EntityTransportBlock.blockY, par1EntityTransportBlock.blockZ);
		if (tileEntity != null) {
